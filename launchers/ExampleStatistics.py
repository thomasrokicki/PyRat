...
meanMovesPerDensity = {fileName:[] for fileName in PLAYERS_FILE_NAMES}
for density in MAZE_DENSITIES :
    for fileName in PLAYERS_FILE_NAMES :
        ...
        meanMovesPerDensity[fileName].append(meanMoves)

# We plot the result
for fileName in PLAYERS_FILE_NAMES :
    plt.plot(MAZE_DENSITIES, meanMovesPerDensity[fileName])
plt.xlabel("Maze density")
