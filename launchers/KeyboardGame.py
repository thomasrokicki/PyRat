...
###################################################################################################################################################################################################################################
#                                                                                                                #                                                                                                                #
#    This script starts 2 players match in which the first token is controlled by the keyboard                   #    Ce script démarre une partie à 2 joueurs dand laquelle le premier jeton est contrôlé par le clavier         #
#    Command line: python KeyboardGame.py <player2FileName>                                                      #    Ligne de commande : python KeyboardGame.py <player2FileName>                                                #
#                                                                                                                #                                                                                                                #
###################################################################################################################################################################################################################################
#                                                                                                                #                                                                                                                #
...
KEYBOARD_FILE_NAME = "./in/Keyboard.py"
...
# We start the game
result = startRandomGame(MAZE_WIDTH, MAZE_HEIGHT, MAZE_DENSITY, MUD_PROBABILITY, MAZE_SYMMETRIC, NB_PIECES_OF_CHEESE, PREPROCESSING_TIME, TURN_TIME, GAME_MODE, OUTPUT_DIRECTORY, TIMEOUT, KEYBOARD_FILE_NAME, PLAYER_2_FILE_NAME)
