...
#    Command line: python TwoPlayersGame.py <player1FileName> <player2FileName>                                  #    Ligne de commande : python TwoPlayersGame.py <player1FileName> <player2FileName>                            #
#                                                                                                                #                                                                                                                #
###################################################################################################################################################################################################################################
#                                                                                                                #                                                                                                                #
...
# We start the game
result = startRandomGame(MAZE_WIDTH, MAZE_HEIGHT, MAZE_DENSITY, MUD_PROBABILITY, MAZE_SYMMETRIC, NB_PIECES_OF_CHEESE, PREPROCESSING_TIME, TURN_TIME, GAME_MODE, OUTPUT_DIRECTORY, TIMEOUT, PLAYER_1_FILE_NAME, PLAYER_2_FILE_NAME)
